...
describe('GET /todos/:id', () => {
	...
	it('should return a 404 for not objectId', (done) => {
		request(app)
		.get(`/todos/1234`)
		.set('x-auth', users[0].tokens[0].token)
		.expect(404)
	...
	it('should not return a todo from other user', (done) => {
		request(app)
...
describe('POST /users', () => {
	...
	it('should request validatior error if request is invalid', (done) => {
		request(app)
		.post('/users')
		.send({
